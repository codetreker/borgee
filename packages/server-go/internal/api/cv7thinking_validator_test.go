...
// TestCV_AgentEditArtifactComment_ThinkingReject 验证设计第 3 条 integration:
...
func TestCV_AgentEditArtifactComment_ThinkingReject(t *testing.T) {
	...
	// non-empty patterns alone are the byte-for-byte set
...
// TestCV_HumanEditArtifactComment_AnyBodyOK 验证设计第 2 条: human-sender
