...
| **S8** | concept §11 + admin §4.1 | 用户隐私承诺页 3 条文案固定 (一字不漏 / 顺序不变), Phase 2 仅准备反查表; 实施推迟到 ADM-1 | (反查表 PR #211) + ADM-1 (post-#223, 待启动) | `docs/qa/adm-1-privacy-promise-checklist.md` (3 条文案固定 + 截屏验收) | Phase 2 只锁文档; 实施与 Phase 4 同期, 不阻塞 Phase 2 退出 (跟 R3-7 一致) |
