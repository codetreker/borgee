...
- No Borgee plugin channel binding; that is task 10.
...
Parallelism:
- First Configure OpenClaw closure task after the typed job/policy dependency clears. Blocks channel-binding and terminal UI closure.
