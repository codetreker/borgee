...
Scope:
- Add fixed schema validation, signed manifest/artifact binding, allowed paths/domains, and declared service ID checks on top of the sandbox/network permission shape from task 5.
...
Parallelism:
- Can run after task 5. Can run alongside task 6 if transport and policy files are separable.
