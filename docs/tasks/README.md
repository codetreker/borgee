...
- gh#718 — 全 repo 黑话整治 (P2, in-flight). sed 时代 12 PR (#721/#723/#725/#726/#727/#728/#729/#730/#731/#732/#733/#734) 已合, 用户拍方法学违反 issue 原文重做; v13+ 按语境读真做, 已合 22 PR / 126 文件 / 余 ~414 文件 / 估 ~70 PR. v17-v34.1 累计 0/605 = 0% 漏率 18 PR (含 v21 + v34 两次 conditional-then-fixed). **3 大里程碑达成** (docs/current/client/ 33 .md 文件 + docs/current/server/ ~32 文件 / 5 子目录 + packages/borgee-helper/ 24 Go 文件 production+test+e2e). Layer 7 防注意力疲劳 12 次成功. v34 教训触发 Layer 7 词典扩 (single-source-of-truth + stance + SSOT + 拆死). 无独立 tasks/ 目录.
