...
| `phase-1-v11-trust-usability-closure/milestone-2-channel-attention-and-authority` | TASKING | `task-4-channel-management-surface` | M2 Task4 owner worker | `.worktrees/m2-task4-channel-management-surface` / `feat/m2-task4-channel-management-surface` | not opened | none | `phase-1-v11-trust-usability-closure/milestone-2-channel-attention-and-authority/task-4-channel-management-surface/progress.md` |
