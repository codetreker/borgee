...
| `phase-1-v11-trust-usability-closure/milestone-2-channel-attention-and-authority` | TASKING | `task-5-channel-allowed-action-rules` | M2 Task5 owner worker | `.worktrees/m2-task5-channel-allowed-action-rules` / `feat/m2-task5-channel-allowed-action-rules` | not opened | none | `phase-1-v11-trust-usability-closure/milestone-2-channel-attention-and-authority/task-5-channel-allowed-action-rules/progress.md` |
